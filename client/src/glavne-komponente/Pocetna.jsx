...
const Pocetna = () => {
  ...
  const handlePrijava = async (e) => {
    ...
    try {
      ...
      setGreska(
        err.response?.data?.poruka || "Došlo je do greške prilikom prijave."
      );
      console.error(err);
    }
  };
  ...
  const handleRegistracija = async (e) => {
    ...
    try {
      ...
      if (odgovor && odgovor.uspesno) {
        ...
        setGreska(
          odgovor?.poruka || "Došlo je do greške prilikom registracije."
        );
      }
    } catch (err) {
      setGreska(
          ...
          <form onSubmit={handlePrijava}>
            <input
              ...
              onChange={(e) =>
                setPrijavaPodaci({
                  ...prijavaPodaci,
                  korisnickoImeIliEmail: e.target.value,
                })
              }
            ...
            <input
              ...
              onChange={(e) =>
                setPrijavaPodaci({ ...prijavaPodaci, sifra: e.target.value })
              }
              placeholder="Šifra"
              className="input-field"
            />
